...
let data=[],m=0
if(!name.includes('.')&&name!="联动"){//角色，光锥
let js_names=await yaml.get('./plugins/xhh/system/default/sr_js_names.yaml')//角色别名
...
if(!m){
let gz_names=await yaml.get('./plugins/xhh/system/default/gz_names.yaml')//光锥别名
